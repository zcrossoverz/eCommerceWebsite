...
const specServices = __importStar(require("../services/specificationService.service"));
const error_1 = require("../utils/error");
const error_2 = __importDefault(require("../middlewares/error"));
const create = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { product_id } = req.params;
    const data = req.body;
    const rs = yield specServices.create(Number(product_id), data);
...
const deleteOne = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const rs = yield specServices.deleteOne(Number(req.params.id));
    return (0, error_1.isError)(rs) ? next((0, error_2.default)(rs, res)) : res.json(rs);
});
...
const updateOne = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const rs = yield specServices.updateOne(Number(req.params.id), { key, value });
    return (0, error_1.isError)(rs) ? next((0, error_2.default)(rs, res)) : res.json(rs);
});
