      ...
      <section className='bg-white dark:bg-gray-900 '>
        <div className='container mx-auto min-h-screen px-6 py-12 lg:flex lg:items-center lg:gap-12'>
          <div className='wf-ull lg:w-1/2'>
            <p className='text-sm font-medium text-blue-500 dark:text-blue-400'>Lỗi 404</p>
            <h1 className='mt-3 text-2xl font-semibold text-gray-800 dark:text-white md:text-3xl'>
              Không tìm thấy trang web
            </h1>
            <p className='mt-4 text-gray-500 dark:text-gray-400'>Xin lỗi chúng tôi không tìm thấy đường link phù hợp</p>
