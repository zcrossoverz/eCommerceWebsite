        ...
        <form className='p-4' noValidate onSubmit={onSubmit}>
          ...
          <div className='text-right'>
            <button
              type='button'
              onClick={handleBack}
              className='w-full rounded-lg bg-slate-200 px-5 py-2.5 text-center text-sm font-medium text-black duration-200 hover:bg-orange-200 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 sm:w-auto'
            >
              Trở lại
            </button>
            <button
              type='submit'
              onClick={onSubmit}
              className='ml-4 w-full rounded-lg bg-orange-500 px-5 py-2.5 text-center text-sm font-medium text-white duration-200 hover:bg-orange-600 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 sm:w-auto'
            >
              Cập nhật
            </button>
          </div>
